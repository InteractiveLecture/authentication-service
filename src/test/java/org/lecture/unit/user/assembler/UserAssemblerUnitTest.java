package org.lecture.unit.user.assembler;
...
/**
 * Unit test for User assemblers.
 * @author Rene Richter
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = {UserAssemblerUnitTestConfig.class})
@WebAppConfiguration
public class UserAssemblerUnitTest {


  @Autowired
  private UserAssembler testInstance;
