package org.lecture.unit.authority.assembler;
...
/**
 * Unit test for Authority assemblers.
 * @author Rene Richter
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = {AuthorityAssemblerUnitTestConfig.class})
@WebAppConfiguration
public class AuthorityAssemblerUnitTest {


  @Autowired
  private AuthorityAssembler testInstance;
